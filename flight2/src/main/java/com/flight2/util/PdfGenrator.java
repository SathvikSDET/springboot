...
public class PdfGenrator {
	    ...
	    public  void generatePDF(String filePath, String name, String emailid, String phone, String operatingAirlines, Date dateofdeparture, String departureCity, String arrivalCity) {
	        try {
	            ...
	            addTitleAndTable(document,name,emailid,phone,operatingAirlines, dateofdeparture.toString(),departureCity,arrivalCity);
	    ...
	    private static void addTitleAndTable(Document document, String name, String emailId, String phone, String operatingAirlines, String dateofdeparture, String departureCity, String arrivalCity)
